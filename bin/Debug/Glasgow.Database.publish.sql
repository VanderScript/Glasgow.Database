...
(
    ...
    @p_batch_type_id INT,
    @p_state_id INT,                -- Changed from UNIQUEIDENTIFIER to INT to match batch_state table
...
INSERT INTO forge.transfer_order_status (status_id, transfer_order_status_name, description) VALUES
